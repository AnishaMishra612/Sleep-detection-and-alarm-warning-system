...
def eye_aspect_ratio(eye):
	...
	A = dist.euclidean(eye[1], eye[5]) # 6 points form one eye , starting from index 0 , p0,p1,p2,p3,p4,p5 so p1-pg,p2-p4 are vertical dist while p0-p3 is horizontal dist
